...
pacstrap /mnt base base-devel linux-zen linux-firmware htop ntp net-tools vim intel-ucode grub efibootmgr nmap git openssh tmux lsb-release zsh fzf zsh-autosuggestions zsh-completions zsh-syntax-highlighting
...
# extra
pacstrap /mnt keepassxc firefox unzip discord docker dos2unix audacity filezilla gimp gnome-sound-recorder grc libreoffice-still ncdu networkmanager-openvpn obs-studio p7zip reflector rsync signal-desktop power-profiles-daemon traceroute tree xclip zip vlc wget yt-dlp
## Gnome
